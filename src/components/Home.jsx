  ...
  const historyTimeline = [
    {
      ...
      year: "3000 BC",
      description:
        "The earliest recorded perfumes originate from ancient Mesopotamia and Egypt, where they were used in religious ceremonies and burial rituals.",
      image: image6,
      color: "#f5f5f5",
    },
    {
      ...
      year: "800 AD",
      description:
        "Persian chemist Al-Kindi wrote the Book of the Chemistry of Perfume and Distillations, documenting 107 recipes for perfumes.",
      image: image7,
      color: "#e0e0e0",
    },
    {
      ...
      year: "14th Century",
      description:
        "Perfume making flourished in Renaissance Europe, particularly in France, where Grasse became the perfume capital of the world.",
      image: image8,
      color: "#f5f5f5",
    },
    {
      ...
      year: "19th Century",
      description:
        "The development of synthetic chemistry allowed for new fragrance compounds, revolutionizing perfume creation and making fine fragrances more accessible.",
      image: image9,
      color: "#e0e0e0",
    },
  ];
        ...
        <Container maxWidth="lg">
          <Grid container spacing={6} alignItems="center">
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                Today, perfumery stands at the intersection of tradition and
                innovation. While we honor ancient techniques and natural
                ingredients, we also embrace cutting-edge technology and
                sustainable practices.
              </Typography>
              <Typography
                variant="body1"
                sx={{ color: "grey.700", lineHeight: 1.8, fontSize: "1.1rem" }}
              >
                At Al Chemist, we continue this legacy by creating fragrances
                that respect the past while looking toward the future—each
                bottle containing not just a scent, but a story centuries in the
                making.
              </Typography>
            </Grid>
          </Grid>
